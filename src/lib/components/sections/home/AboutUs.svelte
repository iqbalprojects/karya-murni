...
<section class="relative">
	<div class="absolute top-0 left-0 z-0 h-[518px]">
		<img src={kmpLeft} alt="Karya Murni" class="h-full w-full object-contain" />
	</div>
	<div class="relative z-10 container mx-auto grid grid-cols-2 gap-x-[74px] p-20">
		<div class="flex max-w-[574px] flex-col justify-between">
			...
			<div class="space-y-5 text-lg text-gray-950">
				<p>
		...
		<div class="relative items-end justify-end">
			...
			<ul class="absolute bottom-6 left-6 space-y-2">
				{#each abouts as about}
					<li
						class="w-[462px] bg-gray-950 px-6 py-5 font-faculty-glyphic text-[22px] text-white first:w-fit last:w-[584px]"
					>
						{about}
					</li>
				{/each}
